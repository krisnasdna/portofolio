<template>
  <div class="mx-5 lg:mx-[80px] my-0">
    <h1 class="text-[42px] lg:text-[230px] font-[900] text-[#334EAC] uppercase leading-none text-center">Want to know more?</h1>
    <h2 class="lg:text-[28px] text-base font-semibold uppercase text-center lg:mt-60 mt-20">Let me take you behind the code.</h2>
