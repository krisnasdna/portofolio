<template>
  <div class="mx-5 lg:mx-[80px] my-0 lg:overflow-hidden ">
    <h1 class="text-[68px] lg:text-[230px] font-[900] text-[#334EAC] uppercase leading-none lg:flex lg:flex-row lg:items-end gap-1 lg:justify-center text-center ">Krisna <span><img src="~/assets/image/icon.png" alt="icon" class="w-10 h-10 mb-8 lg:mb-0 hidden lg:inline"></span>Sedana</h1>
