<template>
  <div class="mx-[80px] my-0 overflow-hidden">
    <h1 class="text-[230px] font-[900] text-[#334EAC] uppercase leading-none flex flex-row items-end gap-1 justify-center">Krisna <span><img src="~/assets/image/icon.png" alt="icon" class="w-10 h-10 mb-8"></span>Sedana</h1>
    <div class="grid grid-cols-3 justify-center items-center h-full">
