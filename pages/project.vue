<template>
  <div class="mx-5 lg:mx-[80px] my-0 lg:overflow-hidden">
    <h1 class="text-[68px] lg:text-[230px] font-[900] text-[#334EAC] uppercase leading-none flex flex-row items-end gap-1 justify-center text-center">My Project <span><img src="~/assets/image/icon.png" alt="icon" class="w-10 h-10 mb-8 hidden lg:inline"></span></h1>
    <div class="grid lg:grid-cols-3 grid-cols-1 justify-center items-center h-full gap-10 lg:gap-0 my-10">
